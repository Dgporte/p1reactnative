...
export default function App() {
  return (
    <View style={biblioteca.containerBiblioteca}>
      <TouchableOpacity style={biblioteca.headerBiblioteca}>
        <Image
      ...
      <Image
        ...
        style={biblioteca.lupaBiblioteca}
      />
      <View style={biblioteca.ordenadorPrincipal}>
        <Text style={biblioteca.ordenarBiblioteca}>ORDENAR POR:</Text>
        <TouchableOpacity style={biblioteca.recenteBiblioteca}>
          <Image
            source={require("./assets/img/arrowbaixo.png")}
